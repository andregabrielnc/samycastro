...
<div class="main-content"><div class="topbar"><div style="display:flex;align-items:center;gap:12px;"><button class="mobile-sidebar-toggle" onclick="document.getElementById('sidebar').classList.toggle('open')"><i class="fas fa-bars"></i></button><h2><i class="fas fa-question-circle"></i> FAQ</h2></div></div>
<div class="content">
...
<table class="admin-table"><thead><tr><th>Categoria</th><th>Pergunta</th><th>Ações</th></tr></thead><tbody>
