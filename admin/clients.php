...
<div style="display:flex;align-items:center;gap:10px;">
    <div class="icon-picker-preview" id="iconPreview"><i class="<?=e($editItem['logo_icon'])?>"></i></div>
    <input type="text" name="logo_icon" id="iconInput" value="<?=e($editItem['logo_icon'])?>" placeholder="Buscar ícone...">
</div>
